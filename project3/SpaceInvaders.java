...
public class SpaceInvaders extends GameEngine implements KeyListener, MouseMotionListener, MouseListener, GameEventListener
{
    ...
    public void render()
    {
        ...
        g2d.drawString( "s End Game", 15, myGameFrame.getHeight() - 1 * lineHeight - yOffset );
    ...
    private void startGame()
    {
        ...
        if ( score == null )
            score = new ScoreSprite();
        if ( lives == null )
            lives = new LivesSprite();
        player.reset();
        score.reset();
        lives.setLives( 3 );
    ...
    private void setLevel( int level )
    {
        synchronized ( spriteList )
        {
            ...
            // Ship is padded 10px above and below the bases and the frame
            invader = new InvaderFleetSprite( new Rectangle( 20, 20, 760, 460 ), 25 );

            spriteList.add( player );
            spriteList.add( invader );
            spriteList.add( score );
            spriteList.add( lives );
        }
    }
    ...
    public void keyPressed( KeyEvent ke )
    {
        ...
        {
            case KeyEvent.VK_S:
                dispatcher.dispatchEvent( new GameEvent( this, GameEventType.Start, null ) );
                break;
            case KeyEvent.VK_P:
                dispatcher.dispatchEvent( new GameEvent( this, GameEventType.Pause, null ) );
                break;
            case KeyEvent.VK_E:
            ...
            case KeyEvent.VK_ESCAPE:
                dispatcher.dispatchEvent( new GameEvent( this, GameEventType.Quit, null ) );
                break;
        }
    }
    ...
    private void manageEvents()
    {
        ...
        while ( true )
        {
            ...
            System.out.println( event.getSource() + "->" + event.getType() + ": " + event.getAttachment() );
