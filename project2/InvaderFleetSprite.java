...
public class InvaderFleetSprite implements Sprite
{
    ...
    public InvaderFleetSprite( Rectangle boundingBox, int invaderCount )
    {
        ...
        for(int invaderNumber = 0; invaderNumber < invaderCount; invaderNumber++)
        {
            ...
            InvaderSprite sprite = new InvaderSprite( invaderNumber % colCount, invaderNumber / colCount,
                    new Dimension( 50, 50 ) );
    ...
    public void update()
    {
        ...
        if ( invaders.isEmpty() )
        {
            dispatcher.dispatchEvent( new GameEvent( this, GameEventType.Start, new Integer( 2 ) ) );
        }
        ...
        if ( controlPoint.y > boundingBox.y + boundingBox.height )
        {
            ...
            fleetXVelocity = 0;
            dispatcher.dispatchEvent( new GameEvent( this, GameEventType.End, new Integer( 1 ) ) );
        }
